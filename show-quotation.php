...
$db		=	new login_function();
	...
	$qu_date			=$db->fetch_quotation_date_by_id($i_id);
		...
		<hr style="margin-bottom:2px; margin-top:3px !important; border:1px dashed black;" />
			...
			?>	
				<tr>
					...
					<td style="font-size:14px !important;"><?php echo $service_name; ?><br /><span style="font-size:12px;"><?php echo $comment; ?></span></td>
			...
			<div style="font-style:italic; margin-top:10px;">Note : As Per Government Rule 18% GST will Be Applicable on Billing Amount.</div>
