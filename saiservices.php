...
<div class="mid-section">
            <h2 style="text-align:center">SAI SERVICES</h2>
			<div style="font-size:13px; text-align:center;">Addr.: Shop No 3,Asra Chowk, Hotgi Road, Solapur, Maharashtra - 413004.</div>
			
			<span style="font-size:13px;"><center>GST NO : 27CMBPA8854R , Ph : +91 9175858330</center></span>

    		<hr style="margin-bottom:2px; margin-top:3px !important; border:1px dashed black;" />
			<h3 style="margin-bottom:0px; margin-top:10px;"><center>Invoice</center></h3>
			<div style="height:30px;margin-bottom:0px;float:right; margin-top:10px;">
				<div class="label-data">Invoice No - <?php echo $display_invoice_no; ?></div> <br />
				<div class="label-data" style="margin-top:0px;" >Date - <?php echo $invoice_date; ?></div>	
			</div>
			<div class="data" style="margin:0px;">
				...
				<div class="info">Mo./Phone </div>-  <?php echo $primary_contact; ?>
				<br />
			...
			<?php
			    ...
			    $packs  =   array("Apple Pack1","Apple Pack 2","Santra Pack 1", "Santra Pack 2","Chiku Pack 1", "Chiku Pack2","Papi Pack 2","Papi Pack 1","Mosambi Pack 1","Mosambi Pack 2","Kalingad Pack 1","Kalingad pack 2");
			    
			    $random_num =   rand(0,11);
				...
				$details = $db->fetch_invoice_cart_data_by_cust_id($i_id);
				if(!empty($details))
				{	$count = 0;
					foreach($details as $record)
					{
						...
						$actual_amount	=	$details[$count][4];
						$discount_amount=	$details[$count][5];
						$comment		=	$details[$count][6];
					    ...
					    $service_name   =   $packs[$random_num];

			?>	
				<tr>
                    <td style="text-align:center;"><?php echo $count+1; ?></td>
					<td style="font-size:14px;"><?php echo $service_name; ?></td>
			...
			<br /><br />
			<p class="footer-data"><b>SAI SERVICES</b><br />
			<label style="font-size:12px;">Seal & Singnature .</label></p><br />
			Phone No : +91 9175858330
			</div>
		</div>
