		...
		<hr style="margin-bottom:2px; margin-top:3px !important; border:1px dashed black;" />
			...
			<div class="data" style="margin:0px;">
				...
				<?php
    			    ...
    			    {
    			?>
				<div class="info">GST No.</div>-  <?php echo $shop_name; ?>
				<?php
			        }
				?>
				<div class="info" style="margin-left:50px;">PO Ref. No. </div>-  <?php echo $other_contact; ?>
				
			    </p>
			</div>
		
			<div style="height:300px;margin-bottom:0px; margin-top:-10px;">
			 <table border="1" style="border-collapse:collapse;width:100%;font-size:12px;">
                <tr>
					<th width="20" rowspan="2">Sr.No</th>
					<th width="3600" rowspan="2" >Title</th>
			...
			?>	
				<tr>
					...
					<td style="font-size:11px !important;"><?php echo $service_name; ?><br /><span style="font-size:12px;"><?php echo $comment; ?></span></td>
			...
			?>
				...
				<?php
					...
					{
					?>
					<div style="margin-top:5px; font-weight:bold; border:1px dashed #666; width:200px;">SAC Code : 998314</div>
					<?php
					}
					?>	
					
					<div class="bank_details" style="margin-top:5px; width:500px; display:inline-table;">
					    <strong>Bank Details : </strong><br />
					    Bank Name : BANK OF INDIA
					    <br />
					    A/C No : 071020110000236
					    <br />
					    IFSC : BKID0000710
					    <br />
					    Branch : Hotgi Road, Solpaur.
					</div>
