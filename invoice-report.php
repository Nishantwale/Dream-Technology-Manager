...
<div class="ibox-body" style="padding:7px; padding-top:0px;">
	...
	<div class="col-sm-4 col-md-4 col-lg-4 form-group mb-6">
	<label class="form-group mb-4 set-row label_marg"><b>Select Bill</b></label>
	<div class="input-group-icon input-group-icon-left  set-row">
	<span class="input-icon input-icon-left"><i class="fas fa-user"></i></span>
		...
		<?php
			...
			if(!empty($report_details))
			{
				...
				<tr>
					...
					<td><a href="show-invoice.php?c_id=<?php echo $id; ?>" target="_blank" style="color:green;">View</a></td>
					<td><a href="show-invoice.php?c_id=<?php echo $id; ?>&hdr" target="_blank" style="color:green;">PRINT WITH HEADER</a></td>
